...
* [`src/foodapp/`](src/foodapp/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/foodapp/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `foodapp` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/foodapp/config.cljs) defaults to `true` in
...
```clj
(ns foodapp.example
  (:require [foodapp.config :as config])
